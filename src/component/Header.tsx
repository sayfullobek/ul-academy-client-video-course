                        ...
                        <div className="row justify-content-between align-items-center">
                                   ...
                                   href="#">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30"
                                        ...
                                        <path stroke="currentColor" stroke-linecap="round" stroke-miterlimit="10"
                                              strokeWidth="2" d="M4 7h22M4 15h22M4 23h22"/>
                                    </svg>
                                </a>
                            </div>
                            ...
                            <div className="app-utilities col-auto">
                                <div className="app-utility-item app-notifications-dropdown dropdown">
                                    {/*<a className="dropdown-toggle no-toggle-arrow"*/}
                                    {/*   id="notifications-dropdown-toggle" data-bs-toggle="dropdown" href="#"*/}
                                    {/*   role="button" aria-expanded="false" title="Notifications">*/}
                                    {/*    <svg width="1em" height="1em" viewBox="0 0 16 16"*/}
                                    {/*         className="bi bi-bell icon" fill="currentColor"*/}
                                    ...
                                    {/*                <div className="col">*/}
                                    {/*                    <div className="info">*/}
                                    {/*                        <div className="desc">Amy shared a file with you. Lorem*/}
                                    ...
                                    {/*                <div className="col">*/}
                                    {/*                    <div className="info">*/}
                                    {/*                        <div className="desc">You have a new invoice. Proin*/}
                                    {/*                            venenatis interdum est.*/}
                                    {/*                        </div>*/}
                                    ...
                                    {/*                <div className="col">*/}
                                    {/*                    <div className="info">*/}
                                    {/*                        <div className="desc">Your report is ready. Proin*/}
                                    {/*                            venenatis interdum est.*/}
                                    {/*                        </div>*/}
                                    ...
                                    {/*                <div className="col">*/}
                                    {/*                    <div className="info">*/}
                                    {/*                        <div className="desc">James sent you a new message.*/}
                                    {/*                        </div>*/}
                                ...
                                {/*        <svg width="1em" height="1em" viewBox="0 0 16 16"*/}
                                {/*             className="bi bi-gear icon" fill="currentColor"*/}
                                {/*             xmlns="http://www.w3.org/2000/svg">*/}
                                {/*            <path fill-rule="evenodd"*/}
                                ...
                                <div className="app-utility-item app-user-dropdown dropdown">
                                    <a className="dropdown-toggle" id="user-dropdown-toggle"
                                       data-bs-toggle="dropdown" href="#" role="button" aria-expanded="false"><img
                                        src={logo} alt="user profile"/>
                                    </a>
                                    <ul className="dropdown-menu" aria-labelledby="user-dropdown-toggle">
                                        {/*<li><Link className="dropdown-item" to={"/auth/settings"}>Account</Link></li>*/}
                                        {/*<li><a className="dropdown-item" href="settings.html">Settings</a></li>*/}
                                        {/*<li>*/}
                                        {/*    <hr className="dropdown-divider"/>*/}
                                        {/*</li>*/}
                                        <li><Button className="dropdown-item" onClick={() => logout()}>Log
                                            Out</Button></li>
                                    </ul>
                                </div>
                            </div>
